          ...
          <div className="gap-5">
            <div>
              ...
              <h1 className="mt-4 text-3xl font-semibold tracking-tight text-white sm:text-4xl">
                Keep approvals, reminders, and recording activity neatly in
                view.
              </h1>
              <p className="mt-3 text-sm leading-6 text-zinc-400">
                A quieter, production-ready inbox with clearer hierarchy, soft
                motion, and dashboard-aligned surfaces for faster triage.
              </p>
            </div>
          </div>
        </motion.section>

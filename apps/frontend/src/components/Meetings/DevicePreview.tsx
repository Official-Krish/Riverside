      ...
      <div className="relative aspect-video overflow-hidden rounded-xl border border-border/70 bg-black/35">
        ...
        {previewError ? (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 px-6 text-center">
            ...
            <div>
              <p className="text-sm font-semibold text-[#fff5de]">Camera preview unavailable</p>
              <p className="mt-1 text-xs leading-5 text-[#d0b27a]/78">
                Allow camera and microphone access, then refresh this page to continue your setup.
              </p>
            </div>
          </div>
        ) : (
          <div className="absolute inset-x-0 bottom-0 flex items-center justify-between gap-3 px-4 py-3 text-xs text-[#fff5de]/78">
            ...
            <span className="hidden text-[#d0b27a]/78 sm:inline">Nothing is uploaded until you join</span>
          </div>
        )}
      </div>
